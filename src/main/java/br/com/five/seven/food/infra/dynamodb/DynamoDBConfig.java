...
public class DynamoDBConfig {
    ...
    public DynamoDbClient dynamoDbClient() {
        ...
        log.info("AWS_ACCESS_KEY: {}", amazonAWSAccessKey);
        log.info("AWS_SECRET_KEY: {}", amazonAWSSecretKey != null ? amazonAWSSecretKey.substring(0, Math.min(4, amazonAWSSecretKey.length())) + "***" : "null");
